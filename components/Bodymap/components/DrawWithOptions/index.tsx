...
const styles = StyleSheet.create({
  container: { flex: 1 },
  actionButton: {
    backgroundColor: ThemeManager.getColorSet().skeduloBackgroundGrey,
    padding: 10,
      ...
      <View style={styles.toolbar}>
        <View style={styles.actionButton}>
          <Pressable onPress={close}>
            <CloseSvg height={20} width={20} fill={ThemeManager.getColorSet().skedBlue900} />
          </Pressable>
        </View>
        ...
        <View style={styles.actionButton}>
          <Pressable onPress={takeSnapshotAndGetUri}>
            <SendSvg height={20} width={20} fill={ThemeManager.getColorSet().skedBlue900} />
          </Pressable>
        </View>
      </View>
      <View
              ...
              <View style={{ ...styles.actionButton, marginRight: 10 }}>
                <Pressable style={styles.option} onPress={deleteSelectedItem}>
                  <ThashSvg
                    width={28}
                    height={28}
                    color={ThemeManager.getColorSet().skedBlue900}
                    strokeWidth={2}
                  />
                </Pressable>
              </View>
